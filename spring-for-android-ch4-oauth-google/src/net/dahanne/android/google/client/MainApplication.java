...
/**
 * This class is based on the MainApplication 
 * found in spring-android-twitter-client and spring-android-facebook-client
 * by Roy Clarkson
 * 
 */
public class MainApplication extends Application {
	...
	private String getClientSecret() {
		return getString(R.string.google_app_secret);
	}
	...
	public GoogleConnectionFactory getGoogleConnectionFactory() {
		return (GoogleConnectionFactory) this.connectionFactoryRegistry.getConnectionFactory(Google.class);
	}
